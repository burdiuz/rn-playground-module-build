...
const STAR_IMAGE = require('react-native-ratings/images/star.png');

const HEART_IMAGE = require('react-native-ratings/images/heart.png');

const ROCKET_IMAGE = require('react-native-ratings/images/rocket.png');

const BELL_IMAGE = require('react-native-ratings/images/bell.png');
...
class SwipeRating extends React.Component {
  ...
  async componentDidMount() {
    try {
      const STAR_IMAGE = await require('react-native-ratings/images/star.png');
      const HEART_IMAGE = await require('react-native-ratings/images/heart.png');
      const ROCKET_IMAGE = await require('react-native-ratings/images/rocket.png');
      const BELL_IMAGE = await require('react-native-ratings/images/bell.png');
      this.setState({
        display: true
      });
    } catch (err) {
  ...
  render() {
    ...
    return this.state.display ? React__default.createElement(reactNative.View, {
      ...
      style: style
    }, showRating && this.displayCurrentRating(), React__default.createElement(reactNative.View, _extends({
...
_defineProperty(SwipeRating, "defaultProps", {
  type: 'star',
  ratingImage: require('react-native-ratings/images/star.png'),
  ratingColor: '#f1c40f',
...
const STAR_IMAGE$1 = require('react-native-ratings/images/airbnb-star.png');

const STAR_SELECTED_IMAGE = require('react-native-ratings/images/airbnb-star-selected.png');
...
_defineProperty$1(Star, "defaultProps", {
...
class TapRating extends React.Component {
  ...
  render() {
    ...
    const rating_array = [];
    const starContainerStyle = [styles$2.starContainer];
    ...
    _.times(count, index => {
      rating_array.push(React__default.createElement(Star, _extends$1({
        key: index,
        position: index + 1,
...
_defineProperty$2(TapRating, "defaultProps", {
  defaultRating: 3,
...
exports.AirbnbRating = TapRating;
exports.Rating = SwipeRating;
